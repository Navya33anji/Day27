...
namespace FileIOOperation
{
    class Program
    {
        ...
        {
            string Path = @"C:\Users\navya\source\repos\FileIOOperation\Example.txt";
            if (File.Exists(Path))
            {
        ...
        {
            string Path = @"C:\Users\navya\source\repos\FileIOOperation\Example1.txt";
        ...
        {
            string Path = @"C:\Users\navya\source\repos\FileIOOperation\Example.txt";
            string CopyPath = @"C:\Users\navya\source\repos\FileIOOperation\CopyFile\CopiedExample.txt";
